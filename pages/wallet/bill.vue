						...
						<view class="goods-size" v-if="tabCurrent === 'tab0'">
							<view class="goodes_detail_swiper-box">
								...
								<view class="user-list x-bc">
									...
									<view class="x-f"><input class="list-val" v-model="form.estimatePrice" disabled="true" /></view>
								</view>
								<view class="user-list x-bc">
									<text class="list-name">预计提成</text>
									<view class="x-f"><input class="list-val" v-model="form.projectCommission" disabled="true" /></view>
								</view>
							</view>
						</view>
						<view class="rich-box" v-show="tabCurrent === 'tab1'">
							<scroll-view :style="{ height: 950 + 'rpx' }" class="scroll-box" scroll-y enable-back-to-top scroll-with-animation @scrolltolower="loadMore">
								<view class="content-box">
									...
									<!-- 空白页 -->
									<app-empty :isFixed="false" v-if="!goodsList.length" :emptyData="emptyData"></app-empty>
								</view>
							</scroll-view>
						</view>
					</view>
